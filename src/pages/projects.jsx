    ...
    projects: [
      {
        ...
        myrole:
          "I did brand analysis of the website and redefined the important parts of the EVOLUTIONS program to put onto the new website. I also created a high fidelity wireframe and style guide for the new site.",
        // github: "",
        report: "",
        mockups: [
          {
        ...
        challenges:
          "Aside from doing this solo, the biggest challenge was trying to create a website with a totally unique atmosphere. The goal was to create a website that felt like one representing a safe and fun science community. One that catered torwards a younger audience but also didn't feel too 'kid-like'. With feedback from my boss, the director of the program, we settled on utilizing the bright logo colors across the website as well as incorporating lots of soft shapes and images.",
      },
      {
        id: 2,
        title: "UClean",
        ...
        myrole:
          "I worked to help organize an complex database for holding the airplane cleaning information required and build the connections for the website to pull data from the databse.",
        // github: "https://github.com/galexford/UClean",
        report:
          "https://drive.google.com/file/d/1QRGSZzoznyEAo7W9DImeAEI5YkXXkKKO/view?usp=sharing",
        mockups: [
          {
      ...
      },
      {
        ...
        myrole:
          "I concepted the original idea for the project and worked with other members to create the original wireframes before implementing them. I also worked to create the components in the Angular framework that would communicate with the database.",
        ...
        challenges:
          "In addition to learning Angular in a short amount of time, learning how to connect toggleable module interfaces with the backend components was difficult. This project required a lot of communication with the backend team in order to get parts working properly.",
      },
    ],
  };
  render() {
